...
extension SVG.AttributeEncoder {
    ...
    @inlinable public subscript(name name: SVG.Attribute) -> Bool {
        get {
            false
        }
        set(bool) {
    ...
    @inlinable public subscript(name name: SVG.Attribute) -> String? {
        get {
            nil
        }
        set(text) {
    ...
    @inlinable public var xmlns: String? {
        get { nil }
        set (value) {
            if  let value: String {
...
extension SVG.AttributeEncoder {
    @inlinable public subscript(
        dynamicMember path: KeyPath<SVG.Attribute.Factory, SVG.Attribute>
    ) -> Bool {
        get {
            false
        }
