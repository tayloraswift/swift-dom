...
extension XML.Sitemap.ContentEncoder {
    ...
    @inlinable public static func += (self: inout Self, string: some StringProtocol) {
...
extension XML.Sitemap.ContentEncoder: DOM.ContentEncoder {
    @usableFromInline typealias AttributeEncoder = XML.Sitemap.AttributeEncoder
...
extension XML.Sitemap.ContentEncoder {
    ...
    /// This is a low-level interface. Prefer encoding with ``subscript(_:content:)``
    /// or ``subscript(_:_:content:)``.
    @inlinable public mutating func close(_ tag: XML.Sitemap.Element) {
