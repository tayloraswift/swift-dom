extension HTML {
    @dynamicMemberLookup @frozen public struct AttributeEncoder: StreamingEncoder {
...
extension HTML.AttributeEncoder {
    ...
    @inlinable public subscript(name name: HTML.Attribute) -> Bool {
        get {
            false
        }
        set(bool) {
    ...
    @inlinable public subscript(name name: HTML.Attribute) -> String? {
        get {
            nil
        }
        set(text) {
...
extension HTML.AttributeEncoder {
    ...
    @inlinable public subscript(data suffix: String) -> String? {
        get {
            nil
        }
        set(text) {
...
extension HTML.AttributeEncoder {
    @inlinable public subscript(
        dynamicMember path: KeyPath<HTML.Attribute.Factory, HTML.Attribute>
    ) -> Bool {
        get {
            false
        }
