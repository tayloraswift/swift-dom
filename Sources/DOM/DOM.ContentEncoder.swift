...
extension DOM.ContentEncoder {
    ...
    @inlinable mutating func emit(closing tag: some RawRepresentable<String>) {
        self.append(escaped: 0x3C) // '<'
